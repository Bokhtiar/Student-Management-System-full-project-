...
<div class="row justify-content-center my-5">
    <div class="col-md-11">
        <form action="{{ isset($edit) ? url('user/student/update', $edit->id) : url('user/student/store') }}" method="POST" class="form-group">
            @csrf
            <div class="row">
            ...
            <div class="form-group float-right text-center my-3">
                <input type="submit" class="btn btn-primary" value="Edit Profile" name="" id="">
            </div>
        </form>
    </div>
</div>
